...
| Continuous watch → alerts | Daily GitHub Actions cron monitors `watchlist.json` repos for **new** dependency CVEs *and* **escalations** of existing ones (newly CISA-KEV-listed, or EPSS jumped ≥ 20 pts), opening a GitHub Issue — no external infra |
